...
describe('agent contracts', () => {
  ...
  it('accepts only the payload that matches the proposed tool', () => {
    ...
    expect(AgentActionProposalSchema.safeParse({ ...base, toolName: 'start_text_generation', input: { communicationGoal: 'inform', sourceMaterial: { facts: { Termin: 'Samstag' }, observations: [], quotes: [], doNotMention: [] }, systemStyleProfileSlug: 'klar_erklaerend', targetPlatforms: ['instagram'] } }).success).toBe(true)
    ...
    expect(AgentActionProposalSchema.safeParse({ ...base, status: 'confirmed', targetRefs: [{ entityType: 'text_workshop_drafts', id: '10000000-6000-4000-8000-000000000001' }], toolName: 'save_content_brief', input: { communicationGoal: 'inform', sourceMaterial: { facts: { Termin: 'Samstag' }, observations: [], quotes: [], doNotMention: [] }, systemStyleProfileSlug: 'klar_erklaerend', targetPlatforms: ['instagram'] } }).success).toBe(true)
