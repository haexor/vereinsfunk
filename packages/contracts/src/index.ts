...
export const RetentionRuleKeySchema = z.enum(['raw_media', 'media_derivatives', 'audit_events', 'expired_tokens', 'consent_evidence', 'stale_exports'])
...
export const WorkflowNameSchema = z.enum(['process-submission', 'anonymize-media', 'render-content', 'apply-revision', 'publish-content', 'collect-analytics', 'cleanup-expired-invitations', 'sync-integration-source', 'enforce-retention'])
