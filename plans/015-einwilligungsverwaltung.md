...
- ~~**Aufbewahrung von Einwilligungsnachweisen**...~~ **Entschieden (2026-08-08): 5 Jahre ab Ende der Gültigkeit (Plan-Vorschlag übernommen).** Paket 020 kann die Frist mit einem manuell auslösbaren Retention-Lauf anwenden; ohne wiederkehrende, überwachte Scheduler-Registrierung ist die Aufbewahrung noch nicht vollständig automatisch technisch durchgesetzt. Paket 004 liefert nur den technischen Outbox-/Worker-Unterbau.
