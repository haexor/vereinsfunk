...
| 028 | [Web-API-Zugriffe vereinheitlichen und große Seiten zerlegen](028-web-api-client-und-grosse-seiten-zerlegen.md) | 027 | in Arbeit; testbarer API-Client mit verbindlichen Web-Tests, API-Mutationen von Marke/Mitgliedern/Integrationen vereinheitlicht; Rechts-/Kanal-/Mitglieder-Ladepfade sowie Audit-, Auftragsverarbeiter-, Vorschau- und fünf Integrations-Komponenten extrahiert. `integrationen.vue` liegt bei 440 LoC; Marke, Mitglieder und die übrigen großen Seiten folgen. |
