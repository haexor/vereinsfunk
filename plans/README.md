...
| 028 | [Web-API-Zugriffe vereinheitlichen und große Seiten zerlegen](028-web-api-client-und-grosse-seiten-zerlegen.md) | 027 | in Arbeit; testbarer API-Client mit verbindlichen Web-Tests, API-Mutationen von Marke/Mitgliedern/Integrationen vereinheitlicht; Rechts-/Kanal-/Mitglieder-Ladepfade sowie Audit-, Auftragsverarbeiter-, Vorschau- und fünf Integrations-Komponenten extrahiert. `integrationen.vue` (440 LoC), `marke.vue` (497 LoC) und `mitglieder.vue` (482 LoC) liegen unter dem Zwischenziel; fünf Web-Testdateien mit zwölf Tests laufen. Offen bleiben `kanaele.vue`, `einstellungen/recht.vue` und der authentifizierte Browser-Smoke-Test. |
