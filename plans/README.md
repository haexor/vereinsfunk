...
| 014 | [Integrationsrahmen und Mitgliederverzeichnis](014-integrationsrahmen-und-mitgliederverzeichnis.md) | 010 | erledigt; Produktivbetrieb ab 020 möglich; HTTP-Adapter und Foto-Upload fürs eigene Profil bewusst nicht enthalten; ein `apply`-Lauf ist weder transaktional noch gegen gleichzeitige/wiederholte Läufe gesichert (siehe ADR-009 „Bekannte Grenzen“; separate Folgearbeit auf dem technischen Unterbau von 004) |
...
| 033 | [Echten Textgenerator und Provider-Routing als USP-Pilot](033-echter-textgenerator-und-provider-routing.md) | 032, laufender Outbox-Dispatcher aus 004 | bereit; aktiviert ausschließlich sichere Textgenerierung. Bild-/Video-Generierung bleibt ein separates, provider-spezifisches Vorhaben. |

Reihenfolge: Paket 004 ist mit einem lokalen registrierten Handler nachgewiesen. Als Nächstes **033** als text-only USP-Pilot ausführen: Provider-Routing, strukturierte LLM-Evaluation, Kandidaten vor akzeptierten Versionen und mobiler Mitgliederfluss. Plan 002 bleibt nur für Foto-/Video-Anhänge nötig und blockiert den Textpilot nicht. Anschließend 032 für Anhänge vervollständigen. Bild- und Videoerzeugung sind ausdrücklich nicht Teil dieser Reihenfolge und benötigen je Provider einen eigenen Spike. Die Stilvorgabe ist als sichtbares, attributbasiertes Profil konzipiert; benannte Persona sind nach ADR-010 erlaubt und organisatorisch über Rollen und Freigabe abzusichern.
