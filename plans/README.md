...
| 014 | [Integrationsrahmen und Mitgliederverzeichnis](014-integrationsrahmen-und-mitgliederverzeichnis.md) | 010 | erledigt; Produktivbetrieb erst nach 020; HTTP-Adapter und Foto-Upload fürs eigene Profil bewusst nicht enthalten; ein `apply`-Lauf ist weder transaktional noch gegen gleichzeitige/wiederholte Läufe gesichert (siehe ADR-009 „Bekannte Grenzen“, gehört zu 004) |
| 015 | [Einwilligungsverwaltung](015-einwilligungsverwaltung.md) | 002, 014 | erledigt; Produktivbetrieb erst nach 020; „Übernahme aus Quellsystem“ (`origin='imported'`) bewusst nicht gebaut (kein Zielsystem mit Testzugang, wie beim HTTP-Adapter aus 014); Textprüfung nur regelbasiert, kein Sprachmodell (Content-Pipeline 001–007 fehlt weiterhin) |
...
- ~~**Aufbewahrung von Einwilligungsnachweisen**~~ **Entschieden (2026-08-08): fünf Jahre ab Ende der Gültigkeit** (Plan-Vorschlag übernommen). Technisch noch nicht durchgesetzt — kein Löschjob, siehe Paket 015 „Umsetzung: Ergebnis und Abweichungen“ und weiterhin Aufgabe von Paket 020.
