...
| 028 | [Web-API-Zugriffe vereinheitlichen und große Seiten zerlegen](028-web-api-client-und-grosse-seiten-zerlegen.md) | 027 | in Arbeit; testbarer API-Client mit verbindlichen Web-Tests, API-Mutationen von Marke/Mitgliedern/Integrationen vereinheitlicht; Rechts-/Kanal-/Mitglieder-Ladepfade sowie Audit-, Auftragsverarbeiter-, Vorschau- und fünf Integrations-Komponenten extrahiert. Alle fünf großen Seiten liegen jetzt unter 500 LoC, darunter `kanaele.vue` (55 LoC) als Composition Root über `useChannels` und `einstellungen/recht.vue` (492 LoC) mit ausgelagerten Formularen; sechs Web-Testdateien mit sechzehn Tests laufen, einschließlich erfolgreichen, schema-validierten Loads und erhaltenen Berechtigungsfehlern. Offen bleibt der authentifizierte Browser-Smoke-Test. |
