...
| 016 | [Auswertung: interne Kennzahlen](016-auswertung-interne-kennzahlen.md) | 011 | erledigt; alle vier Endpunkte (`summary`/`timeseries`/`breakdown`/`funnel`) berechnen live aus den Rohtabellen statt aus einem Cache (Plan vor dem Bauen entsprechend angepasst, siehe Plan „Abweichungen“); neue Tabelle `post_status_events` samt Aufbewahrungsregel; kritischer Fund der adversarialen Prüfung behoben (siehe unten) |
