...
| `evaluateMediaGate` `consentValid` | ✓ 015 (`evaluateConsent` in `packages/domain/src/consent.ts` befüllt ihn; verdrahtet in `GET /v1/approval-stages/mine`, praktisch erst mit einer echten `post_versions`-Zeile pruefbar — Inhalts-Pipeline 001–007 fehlt weiterhin) |
