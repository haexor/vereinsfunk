...
insert into public.composition_sessions (id, organization_id, department_id, communication_goal, requested_formats, source_material, style_profile_snapshot, source_revision, input_hash, target_platforms, created_by) values
  ('76000000-4000-4000-8000-000000000001', '76000000-1000-4000-8000-000000000001', '76000000-1100-4000-8000-000000000001', 'inform', '["text_post"]', '{"facts":{"title":"Blog"},"observations":[],"quotes":[],"forbiddenTopics":[]}', '{}', 1, repeat('a', 64), array['website']::text[], '76000000-0000-4000-8000-000000000001');
