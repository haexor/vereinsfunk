...
export const IMAGE_STYLE_FILTER_OPTIONS: ImageStyleFilterOption[] = [
  ...
  // Nur eine Browser-Näherung: Das echte Hope-Rezept läuft serverseitig über G’MIC und mischt
  // den weicheren Poster-Look mit dem Original, statt das Foto hart zu quantisieren.
  ['gmic_poster', 'Hope Poster', 'Schablonendruck', 'G’MIC', 'contrast(1.24) saturate(1.18)'],
  ...
  ['gmic_hardsketchbw', 'Harte Skizze', 'Kräftige Skizzenlinien über dem Original', 'G’MIC', 'contrast(1.18) saturate(.82)'],
  ['gmic_hearts', 'Herzen', 'Dekoratives Muster', 'G’MIC', 'sepia(.24) saturate(1.45)'],
  ['gmic_houghsketchbw', 'Linien-Skizze', 'Technische Konturen über dem Original', 'G’MIC', 'contrast(1.12) saturate(.82)'],
  ...
  ['gmic_sketchbw', 'Skizze', 'Handgezeichnet über dem Original', 'G’MIC', 'contrast(1.12) saturate(.88)'],
