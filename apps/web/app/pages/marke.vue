        ...
        <div class="lg:sticky lg:top-6 lg:self-start">
          <section class="card p-6">
            ...
            <div class="mt-4 space-y-3">
              <div class="aspect-[9/16] overflow-hidden rounded-[20px] p-6" :style="{ backgroundColor: resolved.primaryColor, color: resolved.onPrimaryColor }">
                <div class="flex h-full flex-col justify-between">
                  <span class="text-[10px] font-bold tracking-[3px] uppercase" :style="{ fontFamily: previewBodyFamily }">Spieltag</span>
                  <h3 class="text-2xl font-extrabold leading-[.95]" :style="{ fontFamily: previewDisplayFamily, color: resolved.accentColor }">Samstag wird laut.</h3>
                  <div class="flex items-center justify-between text-[10px] font-bold" :style="{ fontFamily: previewBodyFamily }">
                    <span>Euer Verein</span>
                    <img v-if="previewLogoUrl" :src="previewLogoUrl" alt="Logo" class="h-6 w-auto" />
                  </div>
                </div>
              </div>
              <div class="aspect-[4/5] overflow-hidden rounded-[20px] p-5" :style="{ backgroundColor: resolved.backgroundColor, color: resolved.textColor }">
                <span class="text-[9px] font-bold tracking-[2px] uppercase opacity-70" :style="{ fontFamily: previewBodyFamily }">Vereinsfunk</span>
                <p class="mt-4 text-lg font-extrabold leading-tight" :style="{ fontFamily: previewDisplayFamily }">Drei Punkte. Ein Team.</p>
                <span class="mt-4 inline-block rounded-lg px-3 py-1.5 text-[10px] font-bold" :style="{ backgroundColor: resolved.accentColor, color: resolved.primaryColor, fontFamily: previewBodyFamily }">Mehr erfahren</span>
              </div>
            </div>
          </section>
        </div>
