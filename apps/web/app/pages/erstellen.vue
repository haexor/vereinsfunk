...
<template>
  <div>
    ...
    <section v-if="!sessionId" class="card grid gap-5 p-5 sm:p-7">
      ...
      <PhotoAttachment v-if="scope?.organizationId && scope.departmentId" v-model="mediaAssetId" :organization-id="scope.organizationId" :department-id="scope.departmentId" />
      <fieldset>
