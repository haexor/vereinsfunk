...
const payload: WorkflowPayload = { entityId: '10000000-0000-4000-8000-000000000001', organizationId: '10000000-1000-4000-8000-000000000001', departmentId: '10000000-1100-4000-8000-000000000001', correlationId: '10000000-1200-4000-8000-000000000001', sourceRevision: 1, purpose: 'initial', idempotencyKey: 'generate-text:test' }
...
function repository(): TextGenerationRepository {
  ...
  return {
    ...
    acquirePendingCandidate: vi.fn().mockResolvedValue({ id: '10000000-1300-4000-8000-000000000001', status: 'generating' }),
    loadActiveTextProvider: vi.fn().mockResolvedValue({ id: 'provider-1', protocol: 'openai', base_url: 'https://provider.example/v1', model: 'synthetic', temperature: 0.2, max_output_tokens: 400, structured_output_required: true, api_key_ciphertext: `\\x${sealed.ciphertext.toString('hex')}`, key_version: 'v1' }), markReady: vi.fn().mockResolvedValue(undefined), markFailed: vi.fn().mockResolvedValue(undefined),
  }
}
...
describe('TextGenerationExecutor', () => {
  ...
  it('leaves a retryable provider failure pending for Hatchet retry', async () => {
    const repo = repository()
